        ...
        function r(e) {
            ...
            (r = t.call(this) || this).onWindowResize = function() {
                ...
                var e = t.deltaY,
                    i = t.deltaX,
                    o = t.originalEvent,
                    n = !!o.composedPath().find(function(t) {
            ...
            }, window.lenisVersion = "0.2.26", r.options = {
                duration: c,
                easing: d,
                smooth: f,
                mouseMultiplier: w,
                ...
                wrapper: x,
                content: P
            }, r.duration = c, r.easing = d, r.smooth = f, r.mouseMultiplier = w, r.smoothTouch = m, r.touchMultiplier = b, r.direction = M, r.gestureDirection = _, r.infinite = E, r.wrapperNode = x, r.contentNode = P, r.wrapperNode.addEventListener("scroll", r.onScroll), r.wrapperNode === window ? (r.wrapperNode.addEventListener("resize", r.onWindowResize), r.onWindowResize()) : (r.wrapperHeight = r.wrapperNode.offsetHeight, r.wrapperWidth = r.wrapperNode.offsetWidth, r.wrapperObserver = new ResizeObserver(r.onWrapperResize), r.wrapperObserver.observe(r.wrapperNode)), r.contentHeight = r.contentNode.offsetHeight, r.contentWidth = r.contentNode.offsetWidth, r.contentObserver = new ResizeObserver(r.onContentResize), r.contentObserver.observe(r.contentNode), r.targetScroll = r.scroll = r.lastScroll = r.wrapperNode[r.scrollProperty], r.animate = new a;
            ...
            return r.virtualScroll = new s({
                ...
                mouseMultiplier: r.mouseMultiplier * (D.includes("Win") || D.includes("Linux") ? .84 : .4),
