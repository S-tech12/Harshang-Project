...
{	
	...
	var position=document.querySelector('#Career #project');	
	if(!document.querySelector('input[name="job_type"]:checked'))
	{
		document.querySelector('#Career #error_data').innerHTML = '* Please Select Job you are Applying for.';
	...
	if(valid_contact()==true){document.querySelector('#Career #form_process').style.visibility="visible";jQuery(this).find('[type="submit"]').prop('disabled', true);//.fadeOut('slow');
